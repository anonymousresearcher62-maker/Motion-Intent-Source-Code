/*
 ...
 This code is courtesy of Apple's sample code taken as a library from 
 https://developer.apple.com/tutorials/app-dev-training/transcribing-speech-to-text
 
 this code is available under a free-use non-restrictive license and i am only using it for the purposes of research.
 */
