...
struct EnrollmentView: View {
    ...
    @State var currentCount = 0 // this is for the window to move to the graph creation
                ...
                .onAppear {
                    if !taskExecuted {
                        ...
                        Task {
                            ...
                            var aiend = start.duration(to:clk.now)
                            print("Finish time for AI: \(aiend)")
                            print("Total time: \(deviceMotionManager.end! + aiend)")
                            print("-----")
                        }
                    }
                    taskExecuted = true
